...
if __name__=='__main__':
    from trip_tool import get_current_datetime, get_current_weather, google_search, calculate
else:   # 다른 소스파일에서 import 할때
    from mylib.trip_tool import get_current_datetime, get_current_weather, google_search, calculate
